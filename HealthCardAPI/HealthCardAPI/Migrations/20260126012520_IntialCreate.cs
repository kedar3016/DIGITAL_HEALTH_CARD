    ...
    public partial class IntialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_aadhaar_mock", x => x.AadhaarNumber);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AadhaarNumber = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    HealthCardNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "Id", "AadhaarNumber", "Address", "BloodGroup", "DateOfBirth", "Email", "Gender", "HealthCardNumber", "Name", "NomineeId", "PhoneNumber", "RegistrationDate" },
                values: new object[] { 1, 123456789012L, "123 MG Road, Bangalore", "A+", new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "rahul@example.com", "Male", "HC123456789012", "Rahul Kumar Sharma", 3016, 7588111644L, new DateTime(2026, 1, 26, 6, 55, 17, 116, DateTimeKind.Local).AddTicks(5169) });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Password", "Role", "Username" },
                values: new object[] { 1, "abc123", "Patient", "123456789012" });
