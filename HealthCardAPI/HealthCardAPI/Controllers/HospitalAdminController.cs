...
namespace HealthCardAPI.Controllers
{
    ...
    public class HospitalAdminController : ControllerBase
    {
        ...
        [HttpGet("verified-doctors")]
        public IActionResult GetVerifiedDoctors()
        {
            var doctors = _context.Doctors
                .Where(d => d.IsVerified)
                .Select(d => new
        ...
        // ❌ UNVERIFY DOCTOR
        [HttpPost("unverify-doctor/{doctorId}")]
        public async Task<IActionResult> UnverifyDoctor(int doctorId)
        {
            var doctor = await _context.Doctors.FindAsync(doctorId);
            ...
            return Ok("Doctor verification revoked. Account deactivated.");
        }
        ...
        // ✅ VIEW VERIFIED LAB TECHNICIANS
        [HttpGet("verified-lab-technicians")]
        public IActionResult GetVerifiedLabTechnicians()
        {
            var technicians = _context.LabTechnicians
                .Where(lt => lt.IsActive) // Fetching technicians where IsActive is true
                .Select(lt => new
                {
                    lt.Id,
                    lt.TechnicianName,
        ...
        // ❌ UNVERIFY LAB TECHNICIAN
        [HttpPost("unverify-lab-technician/{techId}")]
        public async Task<IActionResult> UnverifyLabTechnician(int techId)
        {
            var tech = await _context.LabTechnicians.FindAsync(techId);
            ...
            return Ok("Lab technician verification revoked. Account deactivated.");
        }
