...
export default function DoctorForgotPassword() {
    ...
    const handleSendOtp = async () => {
        ...
        try {
            const res = await api.post("/api/auth/doctor/forgot-password", {
                email
            });

            // Show generic success message, adhering to user request "donot show otp on page"
            // We ignore res.data.message here because the backend currently sends the OTP in the message.
    ...
    const handleResetPassword = async () => {
        ...
        try {
            const res = await api.post("/api/auth/doctor/reset-password", {
                email,
                otp,
                newPassword
            });
