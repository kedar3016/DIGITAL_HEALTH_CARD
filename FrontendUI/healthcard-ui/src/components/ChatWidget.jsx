    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
      <div
        className={`
          pointer-events-auto
          bg-gray-50
          w-[360px] sm:w-[350px] h-[450px] max-h-[60vh]
          rounded-2xl shadow-2xl flex flex-col overflow-hidden
          transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] origin-bottom-right
          border border-gray-200
          ${isOpen ? 'opacity-100 scale-100 translate-y-0 mb-2' : 'opacity-0 scale-90 translate-y-10 mb-0 pointer-events-none h-0'}
        `}
      >
        <div className="bg-white p-4 border-b border-gray-100 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-800 text-sm">Aarogya Sarathi</h3>
        ...
        <div className="p-4 bg-white border-t border-gray-100">
          ...
          <div className="text-center mt-2">
            <p className="text-[10px] text-gray-400">Powered by AarogyaCard</p>
          </div>
        </div>
      </div>
